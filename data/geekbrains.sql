...
-- Дамп данных таблицы geekbrains.attributes: ~35 rows (приблизительно)
...
-- Дамп данных таблицы geekbrains.brand: ~8 rows (приблизительно)
...
-- Дамп данных таблицы geekbrains.cart: ~25 rows (приблизительно)
...
-- Дамп структуры для таблица geekbrains.categories
...
-- Дамп данных таблицы geekbrains.categories: ~4 rows (приблизительно)
...
-- Дамп данных таблицы geekbrains.feedback: ~4 rows (приблизительно)
...
-- Дамп данных таблицы geekbrains.feedback_product: ~10 rows (приблизительно)
...
-- Дамп данных таблицы geekbrains.gallery: ~15 rows (приблизительно)
...
-- Дамп данных таблицы geekbrains.models: ~18 rows (приблизительно)
...
-- Дамп данных таблицы geekbrains.news: ~2 rows (приблизительно)
...
-- Дамп данных таблицы geekbrains.orders: ~10 rows (приблизительно)
...
-- Дамп данных таблицы geekbrains.order_items: ~51 rows (приблизительно)
...
-- Дамп данных таблицы geekbrains.products: ~27 rows (приблизительно)
...
INSERT INTO `products` (`id`, `name`, `description`, `image`, `price`, `quantity_stock`, `categories_id`, `filter_id`) VALUES
	...
	(86, 'Масло универсальное', 'масло', 'undefined.jpg', 2000000, 'Нет в наличии', 3, 0),
	(87, 'Тормозная жидкость', 'жижа', 'undefined.jpg', 32221, 'Нет в наличии', 3, 0),
...
-- Дамп данных таблицы geekbrains.users: ~8 rows (приблизительно)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `login`, `name`, `password_hash`, `cookie_hash`, `last_action`, `is_admin`) VALUES
	(1, 'admin', 'Администратор', '$2y$10$5WKMYg9MUNS6BThn4gHtLuoZlK3N5IcVNnYXRSVNt1FSh9eJCUovK', '', '2020-10-15 09:37:24', b'1'),
	(3, 'vasya', 'Вася', '$2y$10$4ZDj9KyPZ56Un5KDw6WEHeguaDYS4g5QrKtV0Q3KyLwNf3x0jO1au', '9262738935f8c414506ef47.65101352', '2020-10-17 22:20:05', b'0'),
	(4, 'test2', 'Вася', '$2y$10$AIN2fMls4LB7V69ZwTwxHuia9l5RMmkOJYe/7LqdAX4M9bo5rpPPe', NULL, '2020-11-12 12:08:40', b'0'),
	(5, 'www', 'Василий1', '$2y$10$ZaUFeGObVSnmSKnRon6c3OcGL2.SkHjQ4aPJQN7y47vxhaZ2ZtlSS', '', '2020-11-14 00:38:54', b'0'),
	(6, 'seil', 'Марина', '$2y$10$W8OS2BznCfLw/kG9a2mljOdU3C4FwuCesP4KTHleN7ZXymwdPP3Cq', NULL, '2021-11-15 15:59:11', b'0'),
	(7, 'qwerty', 'Марина22', '$2y$10$RYYltSATLEZXUHvHtU9oDOkgmNpj8xQYchgJzTJSeLQkJqYcz0uCO', NULL, '2021-12-03 15:26:36', b'0'),
	(8, 'souls', 'Bogdanova Marina', '$2y$10$H0dOTxUw/h0fnbIFRWR9jegd4fnGZJ4ea8xfBAHkr1Kp729kqTP.G', NULL, '2021-12-27 13:24:21', b'0'),
	(9, 'qweqwe', 'vffffff', '$2y$10$8ljcK9amLqXo/QM1w8dEquuZZpA68qVcqqlSElJ4Xuy/IuGmfUXIW', NULL, '2022-04-05 23:18:55', b'0');
