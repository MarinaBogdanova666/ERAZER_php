        ...
        return `
            ...
            <div class="cart__item_right">   
                <div data-total="${total}">
                    <a class="cart__item_header" href="/catalog/${this.product_id}">${this.product.name}</a>
                </div> 
